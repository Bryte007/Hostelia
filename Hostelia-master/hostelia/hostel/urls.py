...
from .views import success_booking,approve_booking,decline_booking,add_room, remove_room, hm_history, hm_home
...
urlpatterns = [
    ...
    path('hm_dashboard/', views.hm_dashboard, name='hm_dashboard'),
    path('hm_dashboard/<int:hostel_id>/', views.hm_dashboard, name='hm_dashboard_with_id'),    
    path('hm_dashboard/<int:hostel_id>/', views.hm_dashboard, name='hm_dashboard'),

    path('hm_home/', hm_home, name='hm_home'),
